...
def main():
    ...
    esegui(["python3", "03_correlatore_da_vqe.py"], RADICE,
           "FASE 1ter -- 03_correlatore_da_vqe.py (aggiunto in questo aggiornamento)")
    ...
    print(f"\n{'='*70}")
    print("TUTTO COMPLETATO. 19 figure in figure/, dati in dati/.")
    print(f"{'='*70}")
