...
\begin{quote}
\textit{Ultimo passo (addendum su stile e struttura):} prodotti e
verificati end-to-end anche i due pacchetti riproducibili ---
...
(Parte 2, questa pipeline) --- entrambi con \texttt{esegui\_tutto.py}
rieseguito da zero su una copia estratta indipendente, numeri
rigenerati coincidenti con quelli riportati in questo documento e nei
cinque documenti di stadio.
\end{quote}
