...
def _self_test():
    ...
    Speculare al self-test di vqe_trimer_ring.py, aggiunto per uniformita'
    fra i due moduli (RBS e W condividono la stessa logica di stato iniziale,
    solo il blocco parametrico cambia).
    """
    print("=" * 70)
