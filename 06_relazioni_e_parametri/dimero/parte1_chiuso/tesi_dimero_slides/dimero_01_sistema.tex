...
\lVert [H_D, S^2] \rVert = 1.131 \qquad (D=0.2).
\end{equation}
Il numero misura quanto è ``grande'' nel complesso la matrice del
commutatore: si sommano i quadrati di tutti i suoi elementi e se ne prende
la radice --- lo stesso modo in cui si misura la lunghezza di un vettore,
esteso a una matrice invece che a una riga di numeri.
...
\bigskip
\noindent\footnotesize\textit{Riferimento.} Per la norma usata a misurare i
commutatori (radice della somma dei quadrati degli elementi di una matrice):
R.~A.~Horn, C.~R.~Johnson, \emph{Matrix Analysis}, Cambridge University
Press, 2ª ed.\ (2012), cap.~5.
