...
\code{dati/} & dati intermedi (\code{.npz}) generati da 01\_\\
\code{figure/} & le 4 figure finali, in PDF e PNG\\
\code{genera\_figure/} & 4 script, uno per figura\\
\code{01\_genera\_dati\_vqe\_ideale.py} & unico script di generazione dati\\
