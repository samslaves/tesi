...
proprietà si è costruito l'intero argomento dello scan sui parametri di
rumore (Passo 5,
...
dai dati dei correlatori dinamici sotto rumore (Passo 4).
...
Come per il modello di rumore (Passo 1, \texttt{teoria\_modello\_rumore.tex},
