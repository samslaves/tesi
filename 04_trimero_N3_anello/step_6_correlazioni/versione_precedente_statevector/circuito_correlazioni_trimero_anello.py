...
Nota sulla preparazione dello stato: qui si usa la preparazione esatta delle
ampiezze (QuantumCircuit.prepare_state), come già fatto nella simulazione per
il dimero -- lo stato è lo stesso, in linea di principio, che l'ansatz VQE
W-2q.6 prepara con F=1 al punto di lavoro (vedi trimero_anello_vqe_dm.tex).
"""
import numpy as np
...
def correlator_from_circuit(i, alpha, j, beta, t, N, J, Jp, b, D, psi0=None):
    ...
    qc_re = build_correlator_circuit(i, alpha, j, beta, t, N, J, Jp, b, D, 're', psi0)
    qc_im = build_correlator_circuit(i, alpha, j, beta, t, N, J, Jp, b, D, 'im', psi0)
