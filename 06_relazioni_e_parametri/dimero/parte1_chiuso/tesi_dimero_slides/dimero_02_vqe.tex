...
\midrule
0.00 & 0.990290 & $9.7\times10^{-3}$ \\
1.80 & 0.792738 & $2.1\times10^{-1}$ \\
1.99 & 0.525880 & $4.7\times10^{-1}$ \\
\textbf{2.00} & \textbf{0.491178} & $5.1\times10^{-1}$ \\
2.05 & 0.578733 & $4.2\times10^{-1}$ \\
2.50 & 0.934300 & $6.6\times10^{-2}$ \\
4.00 & 0.995060 & $4.9\times10^{-3}$ \\
\bottomrule
\end{tabular}
...
\midrule
1.90 & 0.6734 & 0.3257 & singoletto (il migliore) \\
1.99 & 0.5259 & 0.4735 & singoletto (il migliore) \\
\textbf{2.00} & \textbf{0.5082} & \textbf{0.4912} & $\ket{\downarrow\downarrow}$ --- \textbf{non} il migliore \\
2.01 & 0.4905 & 0.5089 & $\ket{\downarrow\downarrow}$ (il migliore) \\
2.10 & 0.3401 & 0.6595 & $\ket{\downarrow\downarrow}$ (il migliore) \\
\bottomrule
\end{tabular}
...
peggiore ($0.4912$ invece di $0.5082$): un artefatto dello spigolo del
...
autovettore:
\begin{equation*}
\mathcal F = \textstyle\sum_{k:\,E_k\approx E_0} \lvert\langle v_k|\psi_{\rm ansatz}\rangle\rvert^2,
\end{equation*}
...
fisicamente motivato, minimo (Fig.~\ref{fig:confronto}) & PMA base (1 par.) & $0.851664$ \\
