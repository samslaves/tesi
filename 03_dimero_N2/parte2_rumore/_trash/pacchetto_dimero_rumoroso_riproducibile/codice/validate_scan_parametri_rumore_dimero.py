...
RUOLO NELL'INSIEME DEL PACCHETTO: e' lo script di controllo per l'ultimo
stadio della pipeline base -- l'unico dei quattro validate_*.py che
verifica anche una PROPRIETA' ANALITICA (l'invarianza da p_readout), non
solo un confronto numerico con un valore registrato. E' il file che
rende esplicito, con un conto verificato e non solo argomentato, perche'
lo scan sui parametri di rumore possa limitarsi a eps_1q ed eps_2q senza
perdere generalita' rispetto a p_readout.
"""
import numpy as np
