...
\texttt{teoria\_\allowbreak trimero\_\allowbreak catena\_\allowbreak aperta.pdf}), scritti esplicitamente nella
...
(\texttt{derivazione\_\allowbreak stati\_\allowbreak kambe\_\allowbreak trimero.pdf}).
\end{abstract}
...
\texttt{teoria\_\allowbreak trimero\_\allowbreak catena\_\allowbreak aperta.pdf}; qui interessano solo gli
autovettori.
...
quantità conservata (dimostrato in \texttt{teoria\_\allowbreak trimero\_\allowbreak catena\_\allowbreak aperta.pdf}).
...
\begin{align*}
f_1 &\equiv \tfrac1{\sqrt2}\big(|011\rangle+|110\rangle\big) \quad(\text{da }S_{13}{=}1,M_{13}{=}0\otimes|1\rangle_2),\\
f_2 &\equiv |101\rangle \quad(\text{da }S_{13}{=}1,M_{13}{=}{-}1\otimes|0\rangle_2).
\end{align*}
La \eqref{eq:Am12} diventa
...
diretta (stessa funzione \texttt{H\_\allowbreak chain} di
\texttt{verifica\_\allowbreak catena\_\allowbreak preliminare.py}), al punto
$(J,b)=(1.3,-0.7)$ scelto casualmente (nessuna simmetria accidentale che
potrebbe mascherare un errore):
\end{sloppypar}
...
\begin{table}[h]
\centering
\begin{tabular}{@{}p{1.7cm}p{4.9cm}p{7.9cm}@{}}
\toprule
...
\ref{tab:stati}). Dato che, dalla sez.~6 di \texttt{teoria\_\allowbreak trimero\_\allowbreak catena\_\allowbreak aperta.pdf},
...
(Tabella \ref{tab:preparazione}): non c'è, per questa topologia, un analogo "gratuito" del
