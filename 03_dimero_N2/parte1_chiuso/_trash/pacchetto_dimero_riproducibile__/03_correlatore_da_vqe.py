...
ansatz sono molto diverse (0.8517 per PMA base, 1 a dodici cifre per
...
print(f"  fedeltà = {F_base:.6f}  (atteso 0.851664 -- coincide con sqrt=0.9229 del Documento 2 prima dell'uniformazione)")
