...
$|q_1q_2q_3\rangle$ usata nella teoria (Kambe, $S_{12}^2$).
...
\texttt{\seqsplit{trimer\_chain\_exact.py}} (da scrivere, Fase 3) & Benchmark esatto, analogo di \texttt{trimer\_ring\_exact.py} per la topologia a catena. & $1{\to}2,2{\to}1,3{\to}0$ (pianificata)\\
\bottomrule
\end{longtable}

\textbf{Ancora da fare.} VQE (Fase 4), e — più avanti, dopo l'anello —
quantum simulation e correlazioni dinamiche sulla catena, se richieste
dal relatore. Stessa logica di aggiornamento: le nuove sottosezioni
verranno aggiunte qui, in ordine, non in coda al documento.
